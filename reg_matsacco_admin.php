...
if (isset($_POST['register'])) {
    ...
    if (empty($fname) || empty($mname) || empty($lname) || empty($telphone) || empty($entity) || empty($entity_name) || 
        ...
        header("Location: reg_matsacco_admin.php");
        exit();
    }
        ...
        <div class="d-flex justify-content-center align-items-center flex-column">
            <form class="login" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="hidden" class="form-control" value="Sacco" name="sacco" required>
                </div>
				<div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Sacco Admin" readonly>
