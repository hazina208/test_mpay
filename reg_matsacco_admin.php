...
include "DB_connection.php";
    if(isset($_POST['register']))
    {
		...
		$entity=$conn -> real_escape_string($_POST['sacco']);
		$entity_name=$conn -> real_escape_string($_POST['sacco_NAME']);
		...
		if($stmt)
		{
            $_SESSION['status'] = "MATATU SACCO ADMIN REGISTERED SUCCESSFULLY";
            $_SESSION['status_code'] = "success";
            header("location:reg_chama_admin.php");
			
		}
		else {
            $_SESSION['status'] = "MATATU SACCO ADMIN NOT REGISTERED ";
...
<body class="body-login">
    <div class="black-fill"><br /> <br />
    	...
    	<form class="login" method="POST" >
		  ...
		  <div class="mb-3">
		    <label hidden class="form-label">Bus/Mat Sacco</label>
		    <input  type="hidden" class="form-control" value="Matatu Sacco"  name="sacco">
