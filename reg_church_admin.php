<?php
    ...
    if(isset($_POST['register']))
    {
		...
		$entity=$conn -> real_escape_string($_POST['church']);
		$entity_name=$conn -> real_escape_string($_POST['church_name']);
		...
		if($stmt)
		{
            $_SESSION['status'] = "CHURCH ADMIN REGISTERED SUCCESSFULLY";
            $_SESSION['status_code'] = "success";
            header("location:reg_church_admin.php");
			
		}
		else {
            $_SESSION['status'] = "CHURCH ADMIN NOT REGISTERED ";
...
<body class="body-login">
    <div class="black-fill"><br /> <br />
    	...
    	<form class="login" method="POST" >
		  ...
		  <div class="mb-3">
		    <label hidden class="form-label">Church</label>
		    <input  type="hidden" class="form-control" value="Church"  name="church">
		  ...
		  <div class="mb-3">
            ...
            <select id="church_name" name="church_name" >
		  ...
		  <div class="mb-3">
		    ...
		    <input type="text" class="form-control"  placeholder="Church Admin" readonly>
            <input type="hidden" class="form-control" name="role"  value="11" >
