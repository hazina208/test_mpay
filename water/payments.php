          ...
          <?php 
            if(isset($_SESSION['status']) && $_SESSION['status']!='')
            {
             ...
             <div class="row row-cols-5">
               ...
               <a href="" class="col btn btn-dark m-2 py-3" data-bs-toggle="modal" data-bs-target="#WaterPaymentsModal">
              ...
              <br><br>
               ...
               <a href="../logout.php" class="col btn btn-warning m-2 py-3 col-5">
                ...
                <div class="modal fade" id="WaterPaymentsModal" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            <div class="modal-header"><h5>Water Bill Remittances Table</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                ...
                                <div class="modal-body">
                                    <table  id="waterTable" class="table table-bordered ">
                                        ...
                                        $stmt = $conn->prepare("SELECT * FROM water_bills WHERE agency= '$co' ORDER BY agency ASC");
                                        $stmt->execute();
