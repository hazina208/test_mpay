<?php
    ...
    if(isset($_POST['register']))
    {
		...
		$entity=$conn -> real_escape_string($_POST['hospital']);
		$entity_name=$conn -> real_escape_string($_POST['hospital_name']);
		...
		if($stmt)
		{
            $_SESSION['status'] = "HOSPITAL ADMIN REGISTERED SUCCESSFULLY";
            $_SESSION['status_code'] = "success";
            header("location:reg_hospital_admin.php");
			
		}
		else {
            $_SESSION['status'] = "HOSPITAL ADMIN NOT REGISTERED ";
...
<body class="body-login">
    <div class="black-fill"><br /> <br />
    	...
    	<form class="login" method="POST" >
		  ...
		  <div class="mb-3">
		    <label hidden class="form-label">Hospital</label>
		    <input  type="hidden" class="form-control" value="Hospital"  name="hospital">
		  ...
		  <div class="mb-3">
		    ...
		    <input type="text" class="form-control"  placeholder="Hospital Admin" readonly>
