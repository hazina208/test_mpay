<?php
    ...
    if(isset($_POST['register']))
    {
		...
		if($stmt)
		{
            ...
            header("location:reg_electricity_admin.php");
    ...
    <div class="black-fill"><br /> <br />
    	...
    	<form class="login" method="POST" >
		  ...
		  <div class="mb-3">
		    ...
		    <input type="text" class="form-control"  placeholder="Company Admin" readonly>
            <input type="hidden" class="form-control" name="role"  value="13" >
