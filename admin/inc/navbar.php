    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="navLinks">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../reg_sacco_admin.php">Register Sacco Admin</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../reg_matsacco_admin.php">Register Bus/MatSacco Admin</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../reg_cargovehicle_admin.php">Register Cargo Vehicle Sacco Admin</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../reg_event_admin.php">Register Event Admin</a>
                </li>
                <li class="nav-item">
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" href="#"><?php echo htmlspecialchars($row->email); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#"><?php echo htmlspecialchars($row->entity_name); ?></a>
                </li>
                <li class="nav-item">
