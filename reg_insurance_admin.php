<?php
    ...
    if(isset($_POST['register']))
    {
		...
		$entity=$conn -> real_escape_string($_POST['ico']);
		...
		if($stmt)
		{
            $_SESSION['status'] = "INSURANCE COMPANY ADMIN REGISTERED SUCCESSFULLY";
            $_SESSION['status_code'] = "success";
            header("location:reg_insurance_admin.php");
			
		}
		else {
            $_SESSION['status'] = "INSURANCE COMPANY ADMIN NOT REGISTERED ";
    ...
    <div class="black-fill"><br /> <br />
    	...
    	<form class="login" method="POST" >
		  ...
		  <div class="mb-3">
		    ...
		    <input  type="hidden" class="form-control" value="Insurance Company"  name="ico">
