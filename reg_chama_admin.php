...
if (isset($_POST['register'])) {
    ...
    $entity = trim($_POST['chama'] ?? '');
	$entity_name = trim($_POST['chama_name'] ?? '');
    ...
    <div class="black-fill"><br /><br />
        <div class="d-flex justify-content-center align-items-center flex-column">
            <form class="login" method="POST">
                ...
                <div class="mb-3">
                    <label hidden class="form-label">Chama</label>
                    <input type="hidden" class="form-control" value="Chama" name="chama" required>
                </div>
				<div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Chama Admin" readonly>
