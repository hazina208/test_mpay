<?php
    ...
    if(isset($_POST['register']))
    {
		...
		if($stmt)
		{
            $_SESSION['status'] = "CHAMA ADMIN REGISTERED SUCCESSFULLY";
            $_SESSION['status_code'] = "success";
            header("location:reg_chama_admin.php");
			
		}
		else {
            $_SESSION['status'] = "CHAMA ADMIN NOT REGISTERED ";
    ...
    <div class="black-fill"><br /> <br />
    	...
    	<form class="login" method="POST" >
		  ...
		  <div class="mb-3">
		    ...
		    <input  type="hidden" class="form-control" value="Chama"  name="chama">
