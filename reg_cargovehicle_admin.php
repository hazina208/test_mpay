...
if (isset($_POST['register'])) {
    ...
    $entity = trim($_POST['sacco'] ?? '');
	$entity_name = trim($_POST['sacco_name'] ?? '');
    ...
    if (empty($fname) || empty($mname) || empty($lname) || empty($telphone) || empty($entity) || empty($entity_name) || 
        ...
        header("Location: reg_cargovehicle_admin.php");
        exit();
    }
        ...
        <div class="d-flex justify-content-center align-items-center flex-column">
            <form class="login" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="hidden" class="form-control" value="Cargo Sacco" name="sacco" required>
                </div>
				<div class="mb-3">
            		...
            		<select id="sacco_name" name="sacco_name" >
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Cargo Vehicle Admin" readonly>
