<?php
    ...
    if(isset($_POST['register']))
    {
		...
		$entity=$conn -> real_escape_string($_POST['biz']);
		$entity_name=$conn -> real_escape_string($_POST['biz_name']);
		...
		if($stmt)
		{
            $_SESSION['status'] = "BUSINESS ADMIN REGISTERED SUCCESSFULLY";
            $_SESSION['status_code'] = "success";
            header("location:reg_biz_admin.php");
			
		}
		else {
            $_SESSION['status'] = "BUSINESS ADMIN NOT REGISTERED ";
...
<body class="body-login">
    <div class="black-fill"><br /> <br />
    	...
    	<form class="login" method="POST" >
		  ...
		  <div class="mb-3">
		    <label hidden class="form-label">Sacco</label>
		    <input  type="hidden" class="form-control" value="Business"  name="biz">
		  ...
		  <div class="mb-3">
            ...
            <select id="biz_name" name="biz_name" >
                <option value="">-- Select Business --</option>
                    <?php while($row = $result->fetch_assoc()): ?>
                        <option value="<?= $row['biz_name']; ?>"><?= $row['biz_name']; ?></option>
                    <?php endwhile; ?>
                </select>
		  ...
		  <div class="mb-3">
		    ...
		    <input type="text" class="form-control"  placeholder="Business Admin" readonly>
            <input type="hidden" class="form-control" name="role"  value="8" >
