<?php
// ==================== ABSOLUTE OUTPUT CONTROL ====================
// Ensure this is the VERY FIRST line in the file (no blank lines, no spaces, no BOM above it)

ob_start(); // Capture any unwanted output

// Disable error display to prevent HTML warnings leaking
...
// Clean any output generated by requires
if (ob_get_length() > 0) {
    ob_clean();
}
...
set_error_handler(function($errno, $errstr, $errfile, $errline) {
    ...
    echo json_encode([
        'success' => false,
        'message' => "PHP Error: $errstr (File: $errfile, Line: $errline)"
    ]);
    exit;
});
