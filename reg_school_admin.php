<?php
    ...
    if(isset($_POST['register']))
    {
		...
		$entity=$conn -> real_escape_string($_POST['school']);
		$entity_name=$conn -> real_escape_string($_POST['school_name']);
		...
		if($stmt)
		{
            ...
            header("location:reg_school_admin.php");
			
		}
		else {
            $_SESSION['status'] = " ADMIN NOT REGISTERED ";
...
<body class="body-login">
    <div class="black-fill"><br /> <br />
    	...
    	<form class="login" method="POST" >
		  ...
		  <div class="mb-3">
		    <label hidden class="form-label">School</label>
		    <input  type="hidden" class="form-control" value="School"  name="school">
		  ...
		  <div class="mb-3">
            ...
            <input type="hidden" class="form-control" name="role"  value="10" >
